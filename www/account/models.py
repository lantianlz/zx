...
class Profile(models.Model):
    ...
    gender = models.IntegerField(verbose_name=u'性别', default=0, 
        choices=gender_choices, db_index=True)
    avatar = models.CharField(verbose_name=u'头像', max_length=256, default='')
    email_verified = models.BooleanField(verbose_name=u'邮箱是否验证过', 
        default=False)
    mobile_verified = models.BooleanField(verbose_name=u'手机是否验证过', 
        default=False)
...
class UserChangeLog(models.Model):
    ...
    change_type = models.IntegerField(verbose_name=u'变更类型', 
